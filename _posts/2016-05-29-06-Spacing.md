...
Ed Benguiat once said ‘rhythm is type’ and this is important to remember. Frederic Goudy also once said ‘with 26 soldiers of lead, we will conquer the world’ (??) This is a nice image to keep in mind when spacing, thinking of a steady march that is not so loose that the eye finds itself faltering and getting ahead of the sentence it is trying to read, and not so tight that it is difficult to discern the individual letterforms, thus undermining the readability. 
